...
function demoOrdersFixtureEnabled(): boolean {
...
function buildDemoOrdersFixture(now = Date.now()): DemoOrdersFixture {
...
function privateReportOrderSyncKey(
...
export default function App() {
  ...
  const [demoOrdersMode] = useState(() => demoOrdersFixtureEnabled());
  const demoOrdersFixture = useMemo(
    () => (demoOrdersMode ? buildDemoOrdersFixture() : null),
    [demoOrdersMode]
  );
