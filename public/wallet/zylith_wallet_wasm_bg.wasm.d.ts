...
export const zylith_wallet_generate_seed_hex: () => [number, number];
export const zylith_wallet_mnemonic_to_seed_hex: (a: number, b: number) => [number, number, number, number];
